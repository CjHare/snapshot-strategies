...
import * as bitdaoOpenVote from './bitdao-open-vote';
import * as bitdaoRoleVote from './bitdao-role-vote';
...
const strategies = {
  ...
  'bitdao-open-vote': bitdaoOpenVote,
  'bitdao-role-vote': bitdaoRoleVote,
